...
with open("/workspace/twir-series/archive/mastsif/TWIRIBG1.SIF") as f:
    for line in f:
...
print(f"Around 2496: {y0[2490:2500]}")
print(f"Last 10: {y0[-10:]}")

# Save for use
np.save("twiribg1_y0.npy", y0)
